...
namespace Memory
{
    public class Memorys
    {
        ...
        public static void Write<T>(int address, object value, bool kernel = false) where T : struct
        {
            ...
            if (kernel)
                ...
                WinAPI.NtWriteVirtualMemory(Handle, address, buffer, buffer.Length, out BytesWritten);
        }
        ...
        class WinAPI
        {
            ...
            public static extern int NtWriteVirtualMemory(IntPtr hProcess,
                 int lpBaseAddress,
                 byte[] lpBuffer,
                 int dwSize,
                 out IntPtr lpNumberOfBytesWritten);
